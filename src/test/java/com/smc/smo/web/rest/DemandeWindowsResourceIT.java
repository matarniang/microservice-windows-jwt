...
class DemandeWindowsResourceIT {
    ...
    void createDemandeWindows() throws Exception {
        ...
        restDemandeWindowsMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(demandeWindows))
            )
    ...
    void putWithMissingIdPathParamDemandeWindows() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDemandeWindowsMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(demandeWindows)))
    ...
    void patchWithMissingIdPathParamDemandeWindows() throws Exception {
        ...
        restDemandeWindowsMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(demandeWindows))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteDemandeWindows() throws Exception {
        ...
        restDemandeWindowsMockMvc
            .perform(delete(ENTITY_API_URL_ID, demandeWindows.getId()).accept(MediaType.APPLICATION_JSON))
